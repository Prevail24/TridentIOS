...
def main():
    ...
    if executable == "medusa":
        prog_name = "medusa"
        description = "Medusa - The Observatory Command Interface"

    else:
        prog_name = "trident"
        description = "TridentIOS - The Watchers Intelligence Platform"
    ...
    council_parser = subparsers.add_parser(
        "council",
        help="Display the Observatory Council",
    )
    ...
    "report",
    help="Generate a mission report for a host",
)

    report_parser.add_argument(
        "host",
        help="Host to report on",
    )
    ...
    start_parser = mission_subparsers.add_parser(
        "start",
    ...
    mission_subparsers.add_parser(
        "status",
        help="Show active mission",
    )

    mission_subparsers.add_parser(
        "stop",
        help="Stop the active mission",
    )

    mission_subparsers.add_parser(
        "new",
        help="Interactive mission creation",
    )
    ...
    if args.command == "loom":
        ...
        elif args.mission_command == "stop":
            stop_mission()

        elif args.mission_command == "new":
            new_mission()
